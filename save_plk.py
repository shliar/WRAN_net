...
if __name__ == '__main__':
    ...
    if params.dataset == 'dataset':# or params.dataset == 'CUB':
    ...
    if params.model == 'WideResNet28_10':
        ...
        model = res12_mixup_model.resnet12(num_classes=params.num_classes)
    #elif params.model == 'ResNet12':
        #model = resnet12.resnet12(num_classes = params.num_classes)
    model = model.cuda()
    ...
    model.eval()
    output_dict=extract_feature(novel_loader, model, checkpoint_dir, tag='199') 
